...
export const recipeSeeds: RecipeSeed[] = [
  ...
  {
    name: "Maple Bacon Breakfast Burrito",
    description: "Meal-prepped breakfast burritos with maple-glazed bacon, Canadian bacon, fluffy egg whites, shredded potatoes, and a protein cream sauce",
    meal_type: "breakfast", cuisine: "American",
    calories: 435, protein_g: 31, carbs_g: 49, fat_g: 13,
    prep_time_min: 20, cook_time_min: 40, servings: 1,
    ingredients: [
      { name: "Center-cut bacon", qty: 1, unit: "slice" },
      { name: "Canadian bacon", qty: 1, unit: "slice" },
      { name: "Maple syrup", qty: 9, unit: "g" },
      { name: "Whole eggs", qty: 0.7, unit: "large" },
      { name: "Egg whites", qty: 30, unit: "g" },
      { name: "Cottage cheese (low-fat)", qty: 30, unit: "g" },
      { name: "Corn starch", qty: 1.2, unit: "g" },
      { name: "Shredded hash brown potatoes", qty: 48, unit: "g" },
      { name: "Cheddar cheese (shredded)", qty: 6, unit: "g" },
      { name: "Burrito tortilla (large)", qty: 1, unit: "piece" },
      { name: "Fat-free Greek yogurt", qty: 40, unit: "g" },
      { name: "Hot sauce", qty: 5, unit: "g" },
      { name: "Garlic powder", qty: 1, unit: "pinch" },
      { name: "Salt", qty: 1, unit: "pinch" },
      { name: "Thyme", qty: 1, unit: "pinch" },
    ],
    instructions: "Lay center-cut bacon and Canadian bacon on a foil-lined sheet pan. Mix maple syrup with a pinch of salt, garlic powder, and thyme and brush over both sides of the bacon. Bake at 400°F for 15–18 minutes until caramelized and crisp. Set aside. Whisk whole eggs with egg whites, cottage cheese, and corn starch until smooth. Pour into a non-stick skillet over medium-low heat and scramble gently, stirring slowly, until just set — do not overcook. Remove from heat. Cook shredded hash browns in a separate non-stick skillet with a light coat of spray until golden and crisp on both sides, about 4 minutes per side. Season with salt and garlic powder. Make the protein cream sauce: stir Greek yogurt with hot sauce, a pinch of garlic, salt, and pepper until smooth. Lay a burrito tortilla flat. Layer hash browns down the center, then egg mixture, then bacon. Sprinkle cheddar and drizzle cream sauce. Fold in sides and roll tight like a burrito. Repeat for all 10. Wrap each in foil and refrigerate. To reheat: unwrap and microwave 90 seconds, or toast in a skillet 2 minutes per side.",
    tags: ["high-protein", "meal-prep", "bulk-friendly"],
  },

  {
    name: "Honey Buffalo Protein Mac",
    description: "High-protein mac and cheese with grilled chicken, a buffalo-honey glaze, and a creamy cottage cheese sauce",
    meal_type: "lunch", cuisine: "American",
    calories: 555, protein_g: 43, carbs_g: 63, fat_g: 14,
    prep_time_min: 10, cook_time_min: 25, servings: 1,
    ingredients: [
      { name: "Protein pasta", qty: 106, unit: "g" },
      { name: "Chicken breast", qty: 98, unit: "g" },
      { name: "Cottage cheese (0% fat)", qty: 62, unit: "g" },
      { name: "Fat-free cheddar cheese (shredded)", qty: 20, unit: "g" },
      { name: "Mac and cheese powder packet", qty: 8, unit: "g" },
      { name: "Buffalo sauce (low-calorie)", qty: 25, unit: "g" },
      { name: "Fat-free milk", qty: 35, unit: "ml" },
      { name: "Corn starch", qty: 4, unit: "g" },
      { name: "Honey", qty: 12, unit: "g" },
      { name: "Garlic salt", qty: 1, unit: "pinch" },
      { name: "Onion powder", qty: 1, unit: "pinch" },
      { name: "Fresh chives", qty: 5, unit: "g" },
    ],
    instructions: "Season chicken breast with garlic salt and onion powder. Grill or pan-sear over medium-high heat, 6–7 minutes per side, until cooked through (165°F internal). Rest 5 minutes then slice or shred. Cook protein pasta according to package directions until al dente. Drain and return to the pot over low heat. Blend cottage cheese, fat-free cheddar, mac and cheese powder, buffalo sauce, fat-free milk, and corn starch in a blender until completely smooth. Pour cheese sauce over the drained pasta and stir over low heat until thick and creamy, about 2 minutes. Divide into 7 containers. Top each portion with sliced chicken. Mix honey and remaining buffalo sauce and drizzle over the chicken. Garnish with fresh chives. Refrigerate. Reheat in microwave 1.5–2 minutes, stir before eating.",
    tags: ["high-protein", "meal-prep", "bulk-friendly"],
  },

  {
    name: "Chipotle Chicken Bowl",
    description: "Chipotle-marinated grilled chicken thighs over cilantro lime rice with black beans, corn salsa, guacamole, and Monterey Jack",
    meal_type: "dinner", cuisine: "American",
    calories: 680, protein_g: 47, carbs_g: 77, fat_g: 19,
    prep_time_min: 30, cook_time_min: 30, servings: 1,
    ingredients: [
      { name: "Chicken thighs (boneless skinless)", qty: 128, unit: "g" },
      { name: "Chipotle peppers in adobo sauce", qty: 14, unit: "g" },
      { name: "Olive oil", qty: 5, unit: "g" },
      { name: "Lime juice", qty: 10, unit: "ml" },
      { name: "Garlic", qty: 2, unit: "cloves" },
      { name: "Cilantro", qty: 10, unit: "g" },
      { name: "Oregano", qty: 1, unit: "pinch" },
      { name: "Cumin", qty: 1, unit: "pinch" },
      { name: "Chili powder", qty: 1, unit: "pinch" },
      { name: "Adobo seasoning (Goya)", qty: 2, unit: "g" },
      { name: "Long grain white rice (cooked)", qty: 150, unit: "g" },
      { name: "Black beans (canned, drained)", qty: 90, unit: "g" },
      { name: "Frozen sweet corn (thawed)", qty: 70, unit: "g" },
      { name: "Jalapeño (deseeded)", qty: 15, unit: "g" },
      { name: "Red onion", qty: 20, unit: "g" },
      { name: "Avocado", qty: 40, unit: "g" },
      { name: "Monterey Jack cheese (shredded)", qty: 20, unit: "g" },
      { name: "Romaine lettuce (chopped)", qty: 40, unit: "g" },
      { name: "Pico de gallo", qty: 30, unit: "g" },
      { name: "Sour cream (light)", qty: 15, unit: "g" },
    ],
    instructions: "Blend chipotle peppers in adobo, olive oil, lime juice, garlic, cilantro, oregano, cumin, chili powder, and Goya Adobo into a smooth marinade. Coat chicken thighs and marinate at least 1 hour or overnight. Sear marinated chicken in a hot skillet with 1 tbsp olive oil, 3–4 minutes per side to get a deep crust. Reduce heat, cover, and cook through, about 10–12 more minutes. Rest and slice against the grain. For cilantro lime rice: toss hot cooked rice with lime juice, chopped cilantro, and salt. For black beans: heat drained beans with onion powder, lime juice, and salt until warm. For corn salsa: combine thawed corn, diced jalapeño, red onion, cilantro, lime juice, and salt. For guacamole: mash avocado with red onion, jalapeño, lime juice, cilantro, and salt — press plastic wrap directly on the surface to prevent browning. Assemble bowls: rice base, beans, sliced chicken, corn salsa, romaine, pico de gallo, sour cream, and Monterey Jack. Store guac separately and add just before eating.",
    tags: ["high-protein", "meal-prep", "gluten-free"],
  },

  {
    name: "Bulking Protein Shake",
    description: "High-calorie mass gainer shake with oats, banana, peanut butter, and protein powder — blend and drink",
    meal_type: "snack", cuisine: "American",
    calories: 1060, protein_g: 83, carbs_g: 125, fat_g: 30,
    prep_time_min: 5, cook_time_min: 0, servings: 1,
    ingredients: [
      { name: "Rolled oats", qty: 100, unit: "g" },
      { name: "Peanut butter", qty: 10, unit: "g" },
      { name: "Protein powder", qty: 62, unit: "g" },
      { name: "Milk (2%)", qty: 488, unit: "ml" },
      { name: "Banana (medium)", qty: 180, unit: "g" },
    ],
    instructions: "Add all ingredients to a blender in this order: milk first, then oats, banana (broken into chunks), protein powder, and peanut butter on top. Blend on high for 45–60 seconds until completely smooth with no oat chunks remaining. If too thick, add a splash more milk and blend 10 more seconds. Drink immediately — this shake separates and thickens as it sits. For best results consume within 20 minutes of blending.",
    tags: ["high-protein", "bulk-friendly", "quick"],
  },
];
